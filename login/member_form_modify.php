...
<head>
	...
	<script src="../mainJs/jquery-1.12.4.min.js"></script>
    <script src="../mainJs/jquery-migrate-1.4.1.min.js"></script>
<!--
     	...
     	<tr>
     		...
     		<td>
                <label class="hidden" for="hp1">전화번호앞3자리</label>
                    <input type="text" class="hp" name="hp1"  required value="<?= $hp1 ?>">
                <label class="hidden" for="hp2">전화번호중간4자리</label>
                    <input type="text" class="hp" name="hp2" required value="<?= $hp2 ?>"> - 
                <label class="hidden" for="hp3">전화번호끝4자리</label>
                    <input type="text" class="hp" name="hp3" required value="<?= $hp3 ?>">
     		</td>
     	</tr>
     	<tr>
     		<th scope="col">이메일</th>
